...
export const Privacypol = () => {
  return (
    <div className="privPol">
      ...
      <Link to="/profile"><AiOutlineLeft className="left-icon" /></Link>

        <img src={CookBook} alt="" srcset="" />
      </div>
      <div className="privText">
        <h2>Privacy Policy</h2>
        <h4>Privacy Policy for Undefined</h4>
        <div className="polText">
          <p>
            At undefined.tech, accessible from undefined.tech, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by undefined.tech and how we use it. If you have additional
            ...
            undefined.tech. This policy is not applicable to any information
            ...
            fraud Log Files undefined.tech follows a standard procedure of using
            ...
            website, and gathering demographic information. Google DoubleClick
            DART Cookie Google is one of a third-party vendor on our site. It
            also uses cookies, known as DART cookies, to serve ads to our site
            ...
            Policy for each of the advertising partners of undefined.tech.
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on undefined.tech,
            which are sent directly to users' browser. They automatically
            receive your IP address when this occurs. These technologies are
            used to measure the effectiveness of their advertising campaigns
            and/or to personalize the advertising content that you see on
            websites that you visit. Note that undefined.tech has no access to
            or control over these cookies that are used by third-party
            advertisers. Third Party Privacy Policies undefined.tech's Privacy
            ...
            to the following: The right to access – You have the right to
            ...
            guide their online activity. undefined.tech does not knowingly
            ...
            information from our records. Changes to This Privacy Policy We may
            update our Privacy Policy from time to time. Thus, we advise you to
            ...
            page. Our Privacy Policy was created with the help of the TermsFeed
            Privacy Policy Generator. Contact Us If you have any questions or
            suggestions about our Privacy Policy, do not hesitate to contact us.
          </p>
        </div>
      </div>
    </div>
